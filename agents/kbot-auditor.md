---
name: kbot-auditor
description: "Independent code and compliance auditor. Dispatched during PR reviews or before releases. Audits codebase changes against active ADRs, testing standards, and security requirements; stops immediately if source files are missing."
model: inherit
tools:
  - Read
  - Grep

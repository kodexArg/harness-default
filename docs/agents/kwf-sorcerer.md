...
name: kwf-sorcerer
description: >-
  triage-and-fix planner (mid). Same contract as mage; trivial difficulty only.
whenToUse: tavern when difficulty is trivial. Dispatch mid tier.
tools: [Read, Glob, Grep, Agent, Bash]
subagents: [kwf-owl, kwf-cat, kwf-hound, kwf-mouse]
soul: docs/agents/souls/kwf-sorcerer.md
---
...
Personality: load `docs/agents/souls/kwf-sorcerer.md` (voice only; law and contract win).

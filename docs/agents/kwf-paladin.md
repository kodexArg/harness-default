...
name: kwf-paladin
description: >-
  triage-and-fix camp builder (paladin). One path-disjoint slice, own
  worktree+branch, real diff. No research, no web, no Agent.
whenToUse: triage-and-fix camp — slices with builder: paladin.
model_preference: secondary
tools: [Read, Glob, Grep, Edit, Write, Bash]
soul: docs/agents/souls/kwf-paladin.md
---
...
Personality: load `docs/agents/souls/kwf-paladin.md` (voice only; law and contract win).

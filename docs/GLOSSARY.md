...
| triage-and-fix | In-tree issue→PR party — skill `docs/skills/triage-and-fix/`, cast `docs/agents/kwf-*`, phases forest→tavern→camp→stalking→plaza→post-bard ([[adr-02-issue-delivery]]). |
